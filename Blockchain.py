...
class Blockchain:
    ...
    # will add the block to the chain. This method is wrapper for verifying, validating and adding the block. Will
    # take all pending transactions and create and append the blocks to our chain
    def mine(self):
    ...
    # generates a proof of work with the stated difficulty if able to mine a block or not, will update the nonce
    # every iteration. With random nonce
